...
$sql .= 'RIGHT JOIN '.MAIN_DB_PREFIX.'commande as c ON c.fk_soc = s.rowid';
...
if ($search_user > 0) {
	$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."element_contact as ec ON ec.element_id = c.rowid";
	$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."c_type_contact as tc ON ec.fk_c_type_contact = tc.rowid AND tc.element='commande' AND tc.source='internal'";
}
