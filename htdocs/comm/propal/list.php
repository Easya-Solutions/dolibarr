...
$sql .= ' RIGHT JOIN '.MAIN_DB_PREFIX.'propal as p ON p.fk_soc = s.rowid';
...
if ($search_user > 0) {
	$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."element_contact as c ON c.element_id = p.rowid";
	$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."c_type_contact as tc ON c.fk_c_type_contact = tc.rowid AND tc.element='propal' AND tc.source='internal'";
}
