...
class modWorkflow extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = array(
			...
			8=>array('WORKFLOW_TICKET_CLOSE_INTERVENTION', 'chaine', '1', 'WORKFLOW_TICKET_CLOSE_INTERVENTION', 0, 'current', 0),
			9=>array('WORKFLOW_TICKET_CREATE_INTERVENTION', 'chaine', '1', 'WORKFLOW_TICKET_CREATE_INTERVENTION', 0, 'current', 0),
